...
*   **Barbell Strategy:** Extreme safety combined with extreme speculation, avoiding the fragile middle.
*   **Optionality & Convexity:** Benefiting from positive randomness while capping downside risk.
*   **The Lindy Effect:** Valuing age and proven survival over novel fads.
*   **Skin in the Game:** Aligning incentives and avoiding advice from those who don't bear consequences.
*   **Fooled by Randomness:** Recognizing survivorship bias and the narrative fallacy.
...
```bash
# Example
mkdir -p ~/.gemini/antigravity/skills/nassim-taleb-skill
cp SKILL.md ~/.gemini/antigravity/skills/nassim-taleb-skill/
```
...
*   "Analyze this business plan using the Barbell strategy."
*   "How can I apply Via Negativa to my daily productivity routine?"
...
*   **Estrategia Barbell (de Haltera):** Seguridad extrema combinada con especulación extrema, evitando el medio frágil.
*   **Opcionalidad y Convexidad:** Beneficiarse de la aleatoriedad positiva mientras se limita el riesgo de caída.
*   **El Efecto Lindy:** Valorar la antigüedad y la supervivencia probada sobre modas pasajeras.
*   **Skin in the Game (Jugarse la piel):** Alinear incentivos y evitar consejos de quienes no asumen consecuencias.
*   **Engañados por el Azar:** Reconocer el sesgo de supervivencia y la falacia narrativa.
...
*   "Analiza este plan de negocios utilizando la Estrategia Barbell."
*   "¿Cómo puedo aplicar la Vía Negativa a mi rutina diaria de productividad?"
